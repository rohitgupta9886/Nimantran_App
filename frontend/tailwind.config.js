...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Google Stitch Modern Indian Luxury System Tokens
        stitch: {
          surface: '#fff8f5',
          'surface-dim': '#e1d8d3',
          ...
          tertiary: '#4a0e0e',
          'on-tertiary': '#ffffff',
          'tertiary-container': '#672421',
          'on-tertiary-container': '#e98a84',
          'primary-fixed': '#ffd9dd',
          'secondary-fixed': '#ffdf98',
          'tertiary-fixed': '#ffdad7',
          'midnight-canvas': '#0A0205',
          'midnight-surface': '#14050C',
        },
        canvas: '#FAF7F2',
        surface: {
          DEFAULT: '#FFFFFF',
      ...
      fontSize: {
        ...
        'display-lg': ['44px', { lineHeight: '1.2', letterSpacing: '-0.015em', fontWeight: '700' }],
